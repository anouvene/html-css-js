...
jQuery.fn.oiplayer = function(settings) {
    ...
    function fullscreen(player) {
        ...
        if ($(player.div).is('.fullscreen')) {
            ...
            //$(player.ctrls).css('margin-left', '0');
